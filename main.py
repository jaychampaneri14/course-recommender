"""
Course Recommender
Collaborative filtering course recommendation for online learning
...
def main():
    print("=" * 65)
    print(f"  Course Recommender")
    print("=" * 65)
    print(f"  Collaborative filtering course recommendation for online learning")
    print()
